...
void main(void)
{
	...
	//LCD_command(0x80 | 0x00);// first
	//LCD_command(0x80 | 0x10);// third
//	LCD_command(0x80 | 0x20);
//	LCD_command(0x80 | 0x30);
	LCD_command(0x80 | 0x49);// second
	//LCD_command(0x80 | 0x50);// last
